...
# @pytest.fixture
# def client():
#     client_, model_ =  setup_client(model_name='gpt-4o-mini')
#     yield client_
...
# def test_evaluate_with_false_positives(evaluatemodel=model, client=client):
...
#         "f1_score": 0.4,
#     }
#     actual_results = evaluate(claims, ground_truths, model_name, client)

#     assert actual_results['recall'] == expected_results['recall']
#     assert actual_results['precision'] == expected_results['precision']
#     assert actual_results['f1_score'] == expected_results['f1_score']

# def test_evaluate_with_historical_facts(evaluatemodel=model, client=client):
...
# def test_evaluate_with_scientific_facts(evaluatemodel=model, client=client):
...
# def test_evaluate_with_environmental_statements(evaluatemodel=model, client=client):
...
# def test_evaluate_with_health_nutrition_statements(evaluatemodel=model, client=client):
...
# # def test_evaluate_with_technological_advancements(evaluatemodel=model, client=client):
...
# def test_evaluate_with_economic_statements(evaluatemodel=model, client=client):
